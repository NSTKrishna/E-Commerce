...
const navigation = [
  ...
  { name: "Browse Requests", href: "/browse", icon: Search },
  { name: "My Offers", href: "/seller/offers", icon: Send },
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="border-b border-border px-4 py-3">
            <div className="rounded-lg bg-primary/10 px-3 py-2">
              <p className="text-xs font-medium text-primary">Seller Account</p>
            </div>
          </div>
          ...
          <div className="border-t border-border p-4">
            <div className="rounded-lg bg-secondary p-4">
              <h4 className="font-medium text-foreground">Go Pro</h4>
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <DropdownMenuItem>
                  <div className="flex flex-col gap-1">
                    <span className="text-sm font-medium">New request in Design</span>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2">
                  <Avatar className="h-8 w-8">
                    <AvatarFallback className="bg-secondary text-sm">DP</AvatarFallback>
                  </Avatar>
                  <span className="hidden text-sm font-medium sm:inline">DesignPro</span>
