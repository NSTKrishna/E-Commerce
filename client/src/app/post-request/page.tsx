            ...
            {steps.map((step, index) => (
              <div key={step.id} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <div
                    className={`mx-2 h-0.5 w-12 sm:w-20 lg:w-32 ${
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="description"
                      placeholder="Describe what you need in detail. Include specifications, preferences, and any other relevant information..."
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Help sellers understand your price range
                  </p>
                </div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              customBudgetMin: e.target.value,
                            })
                          }
                          className="pl-7"
                        />
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              customBudgetMax: e.target.value,
                            })
                          }
                          className="pl-7"
                        />
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-lg bg-secondary/50 p-4">
                  <p className="text-sm text-muted-foreground">
                    By posting this request, you agree to our Terms of Service and
                    will receive offers from verified sellers. You can edit or
                    close this request at any time from your dashboard.
                  </p>
                </div>
              </div>
            )}
